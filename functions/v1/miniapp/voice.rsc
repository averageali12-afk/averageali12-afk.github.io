...
6:["$","$1","h",{"children":[null,["$","$1","e7Ofo_oMONF0UBvojL-NAv",{"children":[["$","$L13",null,{"children":"$L14"}],["$","meta",null,{"name":"next-size-adjust","content":""}]]}],["$","$L15","e7Ofo_oMONF0UBvojL-NAm",{"children":["$","div",null,{"hidden":true,"children":["$","$16",null,{"fallback":null,"children":"$L17"}]}]}]]}]
e:[["$","$L18",null,{"screen":"voice"}],["$","section",null,{"className":"hero","style":{"paddingBottom":8},"children":[["$","div",null,{"className":"card__eyebrow","children":"مربی روزانه"}],["$","h1",null,{"style":{"fontSize":"2rem"},"children":"گوش بده · تکرار کن · بگو"}],["$","p",null,{"children":"سه دقیقه در روز، یک عبارت واقعی."}]]}],["$","$L19",null,{"initialDialect":"sorani"}]]
