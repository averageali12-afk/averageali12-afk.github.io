...
6:["$","$1","h",{"children":[null,["$","$1","OUhxTLv0R5zX5XTVyOZTBv",{"children":[["$","$L12",null,{"children":"$L13"}],["$","meta",null,{"name":"next-size-adjust","content":""}]]}],["$","$L14","OUhxTLv0R5zX5XTVyOZTBm",{"children":["$","div",null,{"hidden":true,"children":["$","$15",null,{"fallback":null,"children":"$L16"}]}]}]]}]
d:[["$","$L17",null,{"screen":"learn"}],["$","section",null,{"className":"hero","style":{"paddingBottom":4},"children":[["$","div",null,{"className":"card__eyebrow","children":"یادگیری فعال"}],["$","h1",null,{"style":{"fontSize":"2rem"},"children":"تمرین امروز"}],["$","p",null,{"children":"یک عبارت، یک انتخاب، یک بازخورد کوتاه — همه‌روزه."}]]}],["$","$L18",null,{"initialDialect":"kurmanji"}]]
